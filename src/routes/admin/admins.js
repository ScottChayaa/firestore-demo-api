...
router.post(
  "/create-role",
  [adminValidator.bodyUid(), adminValidator.bodyName(), validate],
...
router.put("/:id", adminValidator.bodyName(), validate, adminController.updateAdmin);

// 更新管理員密碼
// PATCH /api/admin/admins/:id/password
router.patch(
  "/:id/password",
  [adminValidator.bodyPassword(), validate],

...
// 引用共用的查詢組合配置（單一來源）
const { validQueryCombinations } = require("./memberQueryConfigurations");
 ...
 *
 * 重要：
 * - 這些測試完全共用 memberController.js 的查詢邏輯
 * - 查詢組合定義在 memberQueryConfigurations.js（單一來源）
 * - 會員 API 需要管理員認證 (Authorization header)
 */
...
describe("Member Query Combinations Summary", () => {
  test("顯示查詢組合統計", () => {
    console.log("\n===========================================");
    console.log("會員查詢組合統計");
    console.log("===========================================");

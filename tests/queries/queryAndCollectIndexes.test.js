...
const QUERY_CONFIGS = [
  {
    ...
    requiresAuth: true,
    validQueryCombinations: require("./config/orderQueryConfigurations").validQueryCombinations,
    paramClassification: require("./config/orderQueryConfigurations").paramClassification,
  },
  {
    name: "會員查詢測試",
    ...
    requiresAuth: true,
    validQueryCombinations: require("./config/memberQueryConfigurations").validQueryCombinations,
    paramClassification: require("./config/memberQueryConfigurations").paramClassification,
  },
  {
    name: "商品查詢測試",
  ...
  },
  {
    ...
    requiresAuth: true,
    validQueryCombinations: require("./config/adminQueryConfigurations").validQueryCombinations,
    paramClassification: require("./config/adminQueryConfigurations").paramClassification,
  },
];
